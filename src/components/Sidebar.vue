  ...
  <nav class="sidebar bg-white dark:bg-gray-800">
    ...
    <div class="sidebar-head p-4">
      <router-link to="/" exact>
        <h2
          ...
          translate="no"
        >
          AVAsharing<span class="text-primary">.</span>
          <span
    ...
    <div class="sidebar-list p-4 mt-4">
      ...
      <div class="wrap-item mt-4 dark:text-gray-500">
        <div class="item">
          ...
          >
            ...
            <span class="w-full"> Статистика </span>
          </router-link>
        </div>
      </div>
     ...
     <router-link
            ...
            class="w-full flex text-left rounded-md box-border p-3 hover:bg-gray-100 dark:hover:bg-gray-700"
          >
        <span class="mr-3 text-xl"><Icon icon="bxs:home" /></span>
        <span class="w-full"> Размещение жилья </span>
      </router-link>
      <div class="item mt-3">
        <router-link to="/component/meRooms">
          <button
          ...
          >
            <span class="mr-3 text-xl"><Icon icon="bxs:home" /></span>
            <span class="w-full"> Мои квартиры </span>
            <span class="box-border mt-1 text-gray-500"> </span>
          </button>
        </router-link>
      </div>
      <div class="item mt-3">
        <router-link to="/component/now">
          <button
            class="text-gray-800 dark:text-gray-500 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 w-full flex text-left rounded-md box-border p-3"
          >
            <span class="mr-3 text-xl"><Icon icon="bi:table" /></span>
            <span class="w-full"> Текущие аренды </span>
            <span class="box-border mt-1 text-gray-500"> </span>
          </button>
        </router-link>
      </div>
      <div class="item mt-3">
        <router-link to="/component/finished">
          <button
            class="text-gray-800 dark:text-gray-500 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-700 w-full flex text-left rounded-md box-border p-3"
          >
            <span class="mr-3 text-xl"><Icon icon="carbon:data-table" /></span>
            <span class="w-full"> История аренд </span>
            <span class="box-border mt-1 text-gray-500"> </span>
          </button>
        </router-link>
      </div>
